...
extension Corner {
    ...
    init(x xEdge: CGRectEdge, y yEdge: CGRectEdge) {
        switch (xEdge, yEdge) {
    ...
    func edge(on axis: Axis) -> CGRectEdge {
        switch axis {
    ...
    func opposite(on axis: Axis) -> Corner {
        switch axis {
...
extension Corner: Opposable {
    static var allOpposites: [(Corner, Corner)] {
