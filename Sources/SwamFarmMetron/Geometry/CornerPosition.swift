...
public enum CornerPosition {
    ...
    init(x xSide: Side, y ySide: Side) {
        switch (xSide, ySide) {
    ...
    func opposite(on axis: Axis) -> CornerPosition {
        switch axis {
...
extension CornerPosition: Rotatable {
    static var allOpposites: [(CornerPosition, CornerPosition)] {
